...
//        videoView.start();
        ...
        TextView btnConnect = findViewById(R.id.btnConnect); //연결시도
    ...
    //데이터송신
    public void setup() {
        TextView btnSend = findViewById(R.id.btnSend); //데이터 전송
        TextView btnSend2 = findViewById(R.id.btnSend2); //데이터 전송
